...
let a = 10
console.log(a);
a = null //빈 값을 대입한다(내용삭제) 'null'로 쓰면 안됨
console.log(a)
//-------------------------------------
...
let c
console.log(b, c);
console.log(b+c); //10+undefined(키워드) = NaN
//Not a Number = NaN
//-------------------------------------
console.log('--------------------------')
let num1 = 10
...
전위, 후위 연산과 관계없이 무조건 1 증가 또는 1 감소된다.
*/
let num2 = 5
let num3 = 0
console.log(`초기값 num2=${num2}, num3=${num3}`) //초기값 num2=5, num3=0
num3 = num2++
