...
console.log(array1) 
//전체 배열 출력(테스트용 전체정상 확인 및 인덱스번호 확인)
console.log(array1[0]) 
//개별 배열 직접 출력(이벤트, 속성, 메서드 동적결과 제작시)
//DOM 변수 생성
...
console.log(product)
console.log(product.size[0], product.color[2])
